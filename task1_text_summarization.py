...
# ─── Install if needed ───
# pip install transformers torch nltk sumy
...
# ══════════════════════════════════════════════
# METHOD 1: Extractive Summarization using NLTK
# (No internet / model download needed)
# ══════════════════════════════════════════════
...
# ══════════════════════════════════════════════
# METHOD 2: Abstractive Summarization (HuggingFace)
...
def abstractive_summarize(text: str, max_length: int = 130, min_length: int = 30) -> str:
    ...
    try:
        ...
        # BART handles ~1024 tokens; truncate long texts
