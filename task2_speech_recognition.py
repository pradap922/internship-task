...
# pip install transformers torch torchaudio   (for wav2vec2)
# sudo apt-get install ffmpeg                 (for pydub)
...
# ══════════════════════════════════════════════
# METHOD 1: SpeechRecognition library (Google API / offline CMU Sphinx)
# ══════════════════════════════════════════════
...
# ══════════════════════════════════════════════
# METHOD 2: Wav2Vec2 (Facebook / HuggingFace — fully offline)
# Downloads ~360 MB model on first run
# ══════════════════════════════════════════════
...
# ══════════════════════════════════════════════
# HELPER: Record from microphone (requires pyaudio)
# ══════════════════════════════════════════════
...
# ══════════════════════════════════════════════
# HELPER: Generate a synthetic test WAV (sine wave)
# so the demo runs without a real audio file.
# ══════════════════════════════════════════════
...
if __name__ == "__main__":
    ...
    # ── Option A: transcribe an existing WAV file ──────────────
